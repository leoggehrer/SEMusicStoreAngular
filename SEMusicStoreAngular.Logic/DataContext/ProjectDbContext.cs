//@CodeCopy
using SEMusicStoreAngular.Common.Modules.Exceptions;
...
{
    /// <summary>
    /// Represents the database context for the SEMusicStoreAngular application.
    /// </summary>
    internal sealed partial class ProjectDbContext : DbContext, IContext
    {
        ...
        /// </summary>
        private static readonly string ConnectionString = "data source=SEMusicStoreAngular.db";
        #endregion fields
