//@CodeCopy
#if ACCOUNT_ON
using SEMusicStoreAngular.Logic.Entities.Account;
using SEMusicStoreAngular.Logic.Modules.Exceptions;
using SEMusicStoreAngular.Logic.Modules.Security;
using System.Text;
using System.Text.RegularExpressions;

namespace SEMusicStoreAngular.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using SEMusicStoreAngular.Common.Modules.ThreadSafe;
